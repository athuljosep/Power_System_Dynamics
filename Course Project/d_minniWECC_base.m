...
pssType = 3*ones(length(pssGen),1);     % wide-area type
% pssType(pssGen == 26) = 1;            % delta-omega type
% pssType(pssGen == 2) = 3;             % wide-area type (one-unit analysis)
...
my_Tw = 10;
my_Kp = 1;   % MUST BE UNITY! PSS gains are set within the PSS model file
...
% gens 1, 2, 13, 14, and 26 (Ryan's note: old comment on units with PSSs?)
...
% sw_con = [...
%      0      0    0    0    0    0    my_Ts    0;  % sets intitial time step
%      5.0    4   79    0    0    1    my_Ts    0;  % apply fault (three phase)
%      5.045  0    0    0    0    0    my_Ts    0;  % clear near end of fault
%      5.05   0    0    0    0    0    my_Ts    0;  % clear far end of fault
%      5.5    0    0    0    0    0    my_Ts    0;  % increase time step
...
% sw_con = [...
%      0      0    0    0    0    0    my_Ts    0;  % sets intitial time step
%      5.0   86   87    0    0    0    my_Ts    0;  % apply fault (three phase)
%      5.095  0    0    0    0    0    my_Ts    0;  % clear near end of fault
%      5.1    0    0    0    0    0    my_Ts    0;  % clear far end of fault
%      5.5    0    0    0    0    0    my_Ts    0;  % increase time step
%     50.0    0    0    0    0    0    my_Ts    0;  % end simulation
% ];

% Do nothing
% sw_con = [...
%      0.0   0    0    0    0    0    my_Ts    0;  % sets intitial time step
%      5.0   18   17   0    0    6    my_Ts    0;  % brake insertion
%      5.5   0    0    0    0    0    my_Ts    0;  % clear near end
%      5.51  0    0    0    0    0    my_Ts    0;  % clear remote end
%     20.0   0    0    0    0    0    my_Ts    0;  % end simulation
% ];
...
% sw_con = [...
%      0.0   0    0    0    0    0    my_Ts    0   ;  % sets intitial time step
%      5.0   18   17   0    0    8    my_Ts    1/14;  % brake insertion
%      5.5   0    0    0    0    0    my_Ts    0   ;  % clear near end
%      5.51  0    0    0    0    0    my_Ts    0   ;  % clear remote end
%     30.0   0    0    0    0    0    my_Ts    0   ;  % end simulation
% ];

% Do nothing case 2
% sw_con = [
%      0      0    0    0    0    0    my_Ts    0;  % sets intitial time step
%      5.0   60   61    0    0    6    my_Ts    0;  % apply fault (loss of line no fault)
%      5.5    0    0    0    0    0    my_Ts    0;  % increase time step
%      5.51   0    0    0    0    0    my_Ts    0;  % increase time step
%    150.0    0    0    0    0    0    my_Ts    0;  % end simulation
% ];

% PV drop (gen 26)
sw_con = [...
    0.0     0    0    0    0    0    my_Ts    0;  % sets intitial time step
    5.0    60   61    0    0    4    my_Ts    0;  % gen trip
    5.5     0    0    0    0    0    my_Ts    0;  % clear near end
    5.51    0    0    0    0    0    my_Ts    0;  % clear remote end
   46.0     0    0    0    0    0    my_Ts    0;  % end simulation
];

% Colstrip drop (gen 14)
% sw_con = [...
%      0      0    0    0    0    0    my_Ts    0;  % sets intitial time step
%      5.0   32   33    0    0    4    my_Ts    0;  % apply fault (loss of line no fault)
%      5.5    0    0    0    0    0    my_Ts    0;  % increas time step
%     50.0    0    0    0    0    0    my_Ts    0;  % end simulation
% ];
...
% sw_con = [...
%      0      0    0    0    0    0    my_Ts    0;  % sets intitial time step
%      7.0    6  106    0    0    0    my_Ts    0;  % apply fault (three phase)
%      7.095  0    0    0    0    0    my_Ts    0;  % clear near end of fault
%      7.1    0    0    0    0    0    my_Ts    0;  % clear far end of fault
%      7.3    0    0    0    0    0    my_Ts    0;  % increas time step
%     20.0    0    0    0    0    0    my_Ts    0;  % end simulation
% ];
