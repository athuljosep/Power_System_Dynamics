...
global pss_idx n_pss pss_sp_idx pss_p_idx pss_wa_idx pss_mb_idx pss_exc_idx;
global pss_T  pss_T2 pss_T4 pss_T4_idx  pss_noT4_idx;
if ~isempty(pss_con)
  pss_idx = find(pss_con(:,1)==1|pss_con(:,1)==2|pss_con(:,1)==3);
  ...
  if n_pss~=0
     ...
     pss_wa_idx = find(pss_con(pss_idx,1)==3);  % wide area PSS
  end
else
  n_pss = 0;
end